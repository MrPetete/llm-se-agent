...
BENCHMARK_CASES = [
    {"id": "TC-01", "name": "Greeting App", "prompt": "Create a Python script that asks for user name and greets them."},
    {"id": "TC-02", "name": "Basic Calculator", "prompt": "Create a calculator that supports addition, subtraction, multiplication, and division."},
    {"id": "TC-03", "name": "CSV Data Summary", "prompt": "Create a script that reads a data.csv file and prints average of the numbers."},
    {"id": "TC-04", "name": "To-Do List (DB)", "prompt": "Create a FastAPI or SQLite based to-do list application with full CRUD."},
    {"id": "TC-05", "name": "Web Scraper", "prompt": "Create a script using BeautifulSoup to scrape article titles from a blog."},
    {"id": "TC-06", "name": "Weather API", "prompt": "Create a Python app that fetches current weather from an open API given a city name."},
    {"id": "TC-07", "name": "FastAPI CRUD", "prompt": "Create a full REST API for managing users with FastAPI."},
